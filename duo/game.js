...
/* L'invité reçoit l'état, mais pas ce qu'il n'a pas le droit de savoir :
   la réponse de l'autre tant qu'elle n'est pas révélée, et le mot secret
   quand ce n'est pas lui qui le connaît. Sans ça, la réponse adverse est
   lisible dans le navigateur avant la révélation. */
...
function diffuse() { envoie({ t: 'S', st: etatPourInvite() }); rendu(); }
